...
const DEFAULT_MESSAGE =
  "Hello, I would like to make an enquiry regarding your products and services. I would also appreciate assistance with my order if needed. Kindly get back to me. Thank you.";
...
export default function WhatsAppHelp() {
  ...
  return (
    <button
      ...
      className="fixed right-4 top-[72%] z-40 -translate-y-1/2 sm:right-6"
      aria-label="Contact us on WhatsApp"
      title="Chat with us on WhatsApp"
    >
      <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-green-500 p-4 text-white shadow-[0_20px_55px_rgba(16,185,129,0.32)] transition duration-200 ease-in-out hover:scale-[1.05]">
        <svg
          width="20"
          height="20"
          viewBox="0 0 24 24"
