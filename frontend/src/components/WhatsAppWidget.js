export default function WhatsAppWidget({
  ...
  return (
    <a
      ...
      className="fixed z-50 right-4 bottom-24 min-h-14 min-w-14 rounded-full bg-green-500 p-4 text-white shadow-[0_20px_55px_rgba(16,185,129,0.32)] transition duration-200 ease-in-out hover:scale-[1.05] flex items-center justify-center"
